...
import { BoxImgLeft, BoxImgRight, BoxTitle, BoxTitleFooter, ContainerLeft, ContainerMain, ContainerRight, FifthCircle, FirstCircle, FourthCircle, ImgStyled, Loading, NumberCircle, NumberFooter, SecondCircle, SeventhCircle, SixthCircle, StyledCirculo, ThirdCircle } from "./styled";
import Sidebar6 from "../../Img/Sidebar6.png"
import Path from "../../Img/Path.png"
import Path2 from "../../Img/Path2.png"
import concurso from "../../Img/concurso.png"
import diaDeSorte from "../../Img/diaDeSorte.png"
        ...
        <ContainerMain>
          ...
          <ContainerLeft>
            <Select sx={{width:"215.91px", height:"45.2px", backgroundColor: "white", borderRadius: "10px"}}
              ...
              <BoxTitleFooter>
                  <img src={concurso}/>
                  <NumberFooter>{mapContests[5]} - {moment(date.data).format("DD/MM/YYYY")}</NumberFooter>
              </BoxTitleFooter>
