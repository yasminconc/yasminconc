...
import { BoxImgLeft, BoxImgRight, BoxTitle, BoxTitleFooter, ContainerLeft, ContainerMain, FifthCircle, FirstCircle, FourthCircle, ImgStyled, Loading, NumberCircle, NumberFooter, SecondCircle, SixthCircle, StyledCirculo, ThirdCircle } from "./styled";
        ...
        <ContainerMain>
          ...
          <ContainerLeft>
            <Select sx={{width:"215.91px", height:"45.2px", backgroundColor: "white", borderRadius: "10px"}}
              ...
              <BoxTitleFooter>
                  <img src={concurso}/>
                  <NumberFooter>{mapContests[0]} - {moment(date.data).format("DD/MM/YYYY")} </NumberFooter>
              </BoxTitleFooter>
