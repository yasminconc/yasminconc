...
import { BoxImgLeft, BoxImgRight, BoxTitle, BoxTitleFooter, ContainerLeft, ContainerMain, ContainerRight, EighthCircle, EleventhCircle, FifteenthCircle, FifthCircle, FirstCircle, FourteenthCircle, FourthCircle, ImgStyled, Loading, NinthCircle, NumberCircle, NumberFooter, SecondCircle, SeventhCircle, SixthCircle, StyledCirculo, TenthCircle, ThirdCircle, ThirteenthCircle, TwelfthCircle } from "./styled";
    ...
    return(
        ...
        <ContainerMain>
          ...
          <ContainerLeft>
              ...
              <BoxTitleFooter>
                  <img src={concurso}/>
                  <NumberFooter>{mapContests[2]} - {moment(date.data).format("DD/MM/YYYY")}</NumberFooter>
              </BoxTitleFooter>
